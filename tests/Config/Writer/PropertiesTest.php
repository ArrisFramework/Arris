...
namespace Tests\Config\Writer;

use Arris\Core\Config\Writer\Properties;
...
class PropertiesTest extends TestCase
{
    ...
    /**
     * @covers \Arris\Core\Config\Writer\Properties::getSupportedExtensions()
     */
    ...
    /**
     * @covers \Arris\Core\Config\Writer\Properties::toString()
     * @covers \Arris\Core\Config\Writer\Properties::toProperties()
     */
...
EOD;
    ...
    /**
     * @covers \Arris\Core\Config\Writer\Properties::toString()
     * @covers \Arris\Core\Config\Writer\Properties::toFile()
     * @covers \Arris\Core\Config\Writer\Properties::toProperties()
     */
    ...
    {
        $this->expectException(\Arris\Core\Config\Exception\WriteException::class);
